  ...
  return (
    <div>
        ...
        <div className='d-flex justify-content-end mt-10'>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-people-fill align-self-center" viewBox="0 0 16 16">
            ...
            <p className='mb-0 mr-5 ml-2'>Welcome, {this.state.currentUser}.</p>
        </div>        
